...
oliiiioooooosdfsdsdfsdfsdf
path = pathlib.Path(__file__).parent.absolute()
llllllllll
MIDI_FILE = str(path)+'\\anima_musica.mid'

WAV_FILE_ORIGINAL = str(path)+'\\anima_musica.wav'
# temporary store for padded version of audio
WAV_FILE_TEMP = str(path)+'\\anima_musica2.wav'
LENGTH = 263 # length of the video file to be generated, in C:\Users\Usuario\Desktop\programacion\trabajar_aqui\anima_musica

OUTPUT_FILE = str(path)+'\\anima_musica.mp4'
...
if MODE == 'play':
    ...
    video = CompositeVideoClip([animation_clip])
